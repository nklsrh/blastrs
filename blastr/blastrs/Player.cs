...
namespace blastrs
{
    ...
    public class Player : Microsoft.Xna.Framework.GameComponent
    {
        ...
        public void Draw(GameTime gameTime, SpriteBatch sb)
        {
            ...
            if (Blasting)
            {   
                sb.Draw(StarImage, Position - Speed, null, TintColour, (float)(gameTime.ElapsedGameTime.Milliseconds / 1000f), new Vector2(Sprite.Width / 2, Sprite.Height / 2), Scale, SpriteEffects.None, 1f);
            }
            sb.End();
        }
    }
